...
public class MovieSearchAdapter extends RecyclerView.Adapter<MovieSearchAdapter.MyViewHolder> {
    ...
    public MovieSearchAdapter(Context context, List<Movie> mData, MovieItemClickListener movieItemClickListener) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MovieSearchAdapter.MyViewHolder myViewHolder = new MovieSearchAdapter.MyViewHolder(view);
        return myViewHolder;
    }
